      ...
      React.createElement("section", {
        ...
        React.createElement("div", {className: "about_content"}, 
          ...
          React.createElement("p", null, 
            "We are a group of developers and designers who looking for exciting" + ' ' +
            "new ideas to build and express our creativity. We build using" + ' ' +
            "Node.js and the latest technologies to deliver a fast and beautiful" + ' ' +
            "experience to users.", 
